...
class IndexedSliceReader extends AbstractIterator<IColumn> implements IColumnIterator
{
    ...
    public IndexedSliceReader(SSTableReader sstable, RowIndexEntry indexEntry, FileDataInput input,
            List<SliceRange> ranges, boolean reversed)
    {
        this.sstable = sstable;
        this.originalInput = input;
        this.reversed = reversed;
        this.ranges = ranges.toArray(new SliceRange[ranges.size()]);
        ...
        try
        {
            if (sstable.descriptor.hasPromotedIndexes)
            {
                ...
                if (indexes.isEmpty())
                {
                    ...
                    this.emptyColumnFamily = ColumnFamily.serializer().deserializeFromSSTableNoColumns(
    ...
    private class IndexedBlockFetcher extends BlockFetcher
    {
        ...
        private final List<IColumn> cache = new ArrayList<IColumn>();
        ...
        public IndexedBlockFetcher()
        {
            this(file.getFilePointer());

        }

        public IndexedBlockFetcher(long position)
        {
